...
- Final-year IT undergraduate at PICT (CGPA: 9.11)
...
**Backend & Systems**
- Spring Boot, Microservices, Node.js, Express.js  
- JWT, Resilience4j, Eureka, OpenFeign

**Frontend**
- React, TypeScript, Material UI, HTML, CSS

**Databases & Cloud**
- PostgreSQL, MySQL, MongoDB, Cloudinary

**DevOps & Observability**
- Docker, NGINX, GitHub Actions  
- Prometheus, OpenTelemetry, PM2
...
### 🔹 Song Sage
AI-powered voice assistant for YouTube Music using FastAPI, speech recognition, and real-time session management.
...
## 📄 Resume
Available on request or via LinkedIn.
